    ...
    render() {
        ...
        return (
           ...
           {/* GEAR PACKING LIST */}
            ...
            <p>Gear</p>
            <div className='gear-container' style={{display: 'flex', flexDirection: 'column', alignItems: 'flex-start', flexWrap: 'nowrap', height: '60vh', border: '2px solid black', overflow: 'scroll'}}>
                <GearList />
            </div>
