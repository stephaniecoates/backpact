...
export default function FirstAid () {
    return (
        ...
        <P>If you received a text and email from Backpact as a designated contact to one of our hikers, they didn't return by their expected end date. If you can't get ahold of them yourself and are concerned that something bad may have happened to them on their trip, it's a good idea to contact authorities and report them missing.</P>
